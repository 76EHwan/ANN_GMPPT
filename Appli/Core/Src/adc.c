...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = LOAD_I_Pin|UCPD1_VSENSE_Pin|OUTPUT_I_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  */
    ...
    PA8     ------> ADC2_INP5
    */
    GPIO_InitStruct.Pin = PANEL_I_Pin|PANEL_V_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOA, LOAD_I_Pin|UCPD1_VSENSE_Pin|OUTPUT_I_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA8     ------> ADC2_INP5
    */
    HAL_GPIO_DeInit(GPIOA, PANEL_I_Pin|PANEL_V_Pin);
