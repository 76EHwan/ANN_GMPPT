 ...
 * --load-mpool-file = "C:/Users/kth59/.stm32cubeaistudio/workspace/ANN_GMPPT/.ai/run/run-1/.ai/memory_pool"
 * --cache-maintenance = true
 * --enable-virtual-mem-pools = true
 * --native-float = true
 * --json-quant-file = "C:/Users/kth59/.stm32cubeaistudio/workspace/ANN_GMPPT/.ai/run/run-1/.ai/st_ai_output/gmpp_model_int8_OE_3_3_1_Q.json"
 * --Os = true
 * --Ocache-opt = true
 * --enable-epoch-controller = true
 * --output-info-file = "c_info"
 * --onnx-input = "C:/Users/kth59/.stm32cubeaistudio/workspace/ANN_GMPPT/.ai/run/run-1/.ai/st_ai_output/gmpp_model_int8_OE_3_3_1.onnx"
 * --out-dir-prefix = "C:/Users/kth59/.stm32cubeaistudio/workspace/ANN_GMPPT/.ai/run/run-1/.ai/st_ai_ws/neural_art__network/"
